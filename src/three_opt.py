...
def three_opt(x1, x2, y1, y2, z1, z2, dist_func):
    ...
    result_tuple = (
        ...
        (4, delelte_cost_3_opt - add_cost_case_4),
        (5, delelte_cost_3_opt - add_cost_case_5),
        (6, delelte_cost_3_opt - add_cost_case_6),
        (7, delelte_cost_3_opt - add_cost_case_7),
    )
            ...
            for l_2 in range(1, len(tour) - 3):
                ...
                for l_3 in range(l_2 + 1, len(tour) - 1):
                    ...
                    if gain > best_gain:
                        ...
                        locally_opt = False
        if not locally_opt:
            print("moving ", tour, candidate_node_i, candidate_node_j,
...
def algorithm(solution):
    ...
    for route in solution.routes:
        route[:-1], gain = three_opt_best_gain(
            route[:-1], distance)
