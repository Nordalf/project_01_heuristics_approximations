...
\begin{algorithm}[!ht]
	...
	\State $\var{capacity} \gets \var{capacity} + \var{startpoint.capacity}$
		\While{\texttt{$excludelist.length \le customers.length$}}
...
\begin{figure}
	\centering
	\subfloat[Heuristic NN Algorithm - Custom]{\includegraphics[width=0.7\textwidth]{solverNN_algorithm_boxplot.png}\label{fig:NN_heuristic_fig}}
\end{figure}

\begin{figure}[!htb]
	\centering
	\subfloat[Heuristic Cluster Algorithm - Custom]{\includegraphics[width=0.7\textwidth]{solverCHH_algorithm_boxplot.png}\label{fig:Cluster_heuristic_fig}}
\end{figure}

\begin{figure}[!htb]
	\centering
	\subfloat[Local Search Algorithm - Custom - Close index route for NN heustic]{\includegraphics[width=0.7\textwidth]{SolverLS_close_index_route_swap_solverNN_algorithm_boxplot.png}\label{fig:custom_close_idx_localsearch_boxplot_fig_nn}}
\end{figure}
\begin{figure}[!htb]
	\centering
	\subfloat[Close Index Custom Local Search Figure for cluster heuristic]{\includegraphics[width=0.7\textwidth]{SolverLS_close_index_route_swap_solverCHH_algorithm_boxplot.png}\label{fig:custom_close_idx_localsearch_boxplot_fig_cluster}}
\end{figure}

\begin{figure}[!htb]
	\centering
	\subfloat[Local Search Algorithm - Custom - All index combinations route for NN heuristic]{\includegraphics[width=0.7\textwidth]{SolverLS_all_combination_route_swap_solverNN_algorithm_boxplot.png}\label{fig:all_combinations_localsearch_boxplot_fig_nn}}
\end{figure}
\begin{figure}[!htb]
	\centering
	\subfloat[Local Search Algorithm - Custom - All index combinations route for cluster heuristic]{\includegraphics[width=0.7\textwidth]{SolverLS_all_combination_route_swap_solverCHH_algorithm_boxplot.png}\label{fig:all_combinations_localsearch_boxplot_fig_cluster}}
\end{figure}

%\section{\\Local Search Algorithm - Custom - Convex Compare}


\begin{figure}[!htb]
	\centering
	\subfloat[Local Search Algorithm - Known - Two Opt for NN heuristic]{\includegraphics[width=0.7\textwidth]{TwoOPT_solverNN_algorithm_boxplot.png}\label{fig:two_opt_nn}}
\end{figure}
\begin{figure}[!htb]
	\centering
	\subfloat[Two Opt Known Local Search Figure for cluster heuristic]{\includegraphics[width=0.7\textwidth]{TwoOPT_solverNN_algorithm_boxplot.png}\label{fig:two_opt_cluster}}
\end{figure}
